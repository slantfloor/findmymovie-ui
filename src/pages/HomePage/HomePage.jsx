...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-[#121417] text-white font-sans w-full">
      <div className="w-full px-4 sm:px-8">
        ...
        {/* Hero Section */}
        <section className="py-12 text-center flex flex-col items-center w-full">
          <h1 className="text-3xl sm:text-5xl font-extrabold leading-tight w-full">
            Find Movies by <span className="text-blue-500">Memorable Quotes</span>
          </h1>
          <p className="text-gray-400 mt-4 text-sm sm:text-base w-full sm:w-2/3">
            Remember that perfect line but can't recall the movie? Just type it in and discover the film that made it famous.
          </p>

          {/* Search */}
          <form
            className="mt-8 w-full sm:w-2/3 flex items-center bg-[#1a1e27] rounded-lg"
          ...
          >
            ...
            >
              <svg className="h-5 w-5 mr-1" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex flex-wrap justify-center space-x-4 md:space-x-10 mt-8 text-gray-400 text-sm sm:text-base">
            {[
              ...
              <div key={index} className="flex items-center space-x-2 cursor-pointer hover:text-white mt-4 sm:mt-0">
                {icon === "check" && (
        ...
        <section className="w-full mt-16">
          <h2 className="text-xl font-semibold mb-6 text-center">Popular Searches</h2>
        ...
        {/* Features */}
        <section className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 w-full text-center">
          {[
            {
              title: "Smart Search",
        ...
        {/* Footer */}
        <footer className="py-6 text-center text-gray-500 border-t border-gray-800 text-xs sm:text-sm mt-16">
